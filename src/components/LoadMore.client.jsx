...
// Define a `LoadMore` component that takes `children` and `current` (the current number of products to display on the page) as props.
  ...
  return (
    <div>
      ...
      <div className="py-10 text-center">
        <button
          onClick={() => {
            setServerProps('first', current + 3); // Update a top-level server component prop based on key
          }}
